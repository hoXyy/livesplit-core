...
pub(crate) enum Text {
    ...
    ComponentResetChance,
    ComponentSuccessChance,
    ComponentRunsEnded,
    ResetChanceShort,
    SuccessChanceShort,
    RunsEndedShort,
    ResetChanceBackground,
    ResetChanceBackgroundDescription,
    ResetChanceMode,
    ResetChanceModeDescription,
    ResetChanceAccuracy,
    ResetChanceAccuracyDescription,
    ResetChanceTrailingZeroes,
    ResetChanceTrailingZeroesDescription,
    ResetChanceBasis,
    ResetChanceBasisDescription,
    ResetChanceRecentRuns,
    ResetChanceRecentRunsDescription,
    ResetChanceRecentSplitAttempts,
    ResetChanceRecentSplitAttemptsDescription,
    ResetChanceDisplayTwoRows,
    ResetChanceDisplayTwoRowsDescription,
    ResetChanceLabelColor,
    ResetChanceLabelColorDescription,
    ResetChanceValueColor,
    ResetChanceValueColorDescription,
}
