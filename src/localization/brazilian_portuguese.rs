...
pub const fn resolve(text: Text) -> &'static str {
    match text {
        ...
        Text::Reset => "Resetar",
        Text::ResetDescription => "O atalho de teclado para resetar a tentativa atual.",
        Text::UndoSplit => "Desfazer split",
        Text::UndoSplitDescription => "O atalho de teclado para desfazer o último split.",
        Text::SkipSplit => "Pular split",
        Text::SkipSplitDescription => "O atalho de teclado para pular o split atual.",
        Text::Pause => "Pausar",
        ...
        Text::DigitsFormatDescription => {
            "Indica quantos dígitos mostrar. Se a duração for menor do que o número de dígitos, zeros serão exibidos."
        }
        ...
        Text::ShowFinishedRunsCount => "Mostrar número de corridas concluídas",
        Text::ShowFinishedRunsCountDescription => {
            "Indica se o número de corridas concluídas com sucesso deve ser exibido."
        }
        Text::ShowAttemptCount => "Mostrar número de tentativas",
        ...
        Text::ComponentDetailedTimer => "Timer detalhado",
        Text::ComponentGraph => "Gráfico",
        Text::ComponentPbChance => "Chance de PB",
        Text::ComponentPossibleTimeSave => "Tempo possível de economizar",
        ...
        Text::CarouselIntervalDescription => {
            "O número máximo de segundos durante os quais um componente filho é exibido antes de passar para o seguinte. O carrossel pode mudar antes se o conteúdo de outro componente filho tiver mudado de forma significativa."
        }
        Text::CarouselMinDisplay => "Exibição mínima (segundos)",
        Text::CarouselMinDisplayDescription => {
            "O número mínimo de segundos para exibir um componente filho antes de trocar para outro."
        }
...
pub const fn resolve_placeholder(text: PlaceholderText) -> &'static [Piece] {
    match text {
        PlaceholderText::SumOfBestCleanerSegmentTimeBetween => &[
            Piece::Static("Você teve um tempo de segmento de "),
            Piece::Dynamic(0),
            Piece::Static(" de "),
            Piece::Dynamic(1),
            Piece::Static(" entre “"),
        ...
        PlaceholderText::SumOfBestCleanerRunOn => &[
            Piece::Static(" em uma corrida em "),
            Piece::Dynamic(0),
